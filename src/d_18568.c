...
Point16 g_MmxSensorsCeiling[] = {{0, -16}, {0, -16}, {4, -16}, {-4, -16}};
Point16 g_MmxSensorsFloor[] = {{0, 28}, {0, 24}, {4, 24}, {-4, 24}};
Point16 g_MmxSensorsWall[] = {
    {7, 23},  {7, 16},  {7, 8},  {7, 0},  {7, -8},  {7, -8},  {7, -15},
    {-7, 23}, {-7, 16}, {-7, 8}, {-7, 0}, {-7, -8}, {-7, -8}, {-7, -15}};
u16 g_MmxSensorsCeilingDefault[] = {-16, -16, -16, -16};
u16 g_MmxSensorsFloorDefault[] = {28, 24, 24, 24};
u16 g_MmxSensorsWallDefault[] = {23, 16, 8, 0, -8, -8, -15, 0};
u16 g_MmxSensorsCeilingCrouch[] = {0, 0, 0, 0};
u16 g_MmxSensorsWallCrouch[] = {23, 16, 8, 4, 4, 1, 1, 0};
