...
SpriteParts* g_SpritesItems[] = {
    (SpriteParts*)NULL,
    (SpriteParts*)sprt_item_power_capsule_small_closed,
    (SpriteParts*)sprt_item_power_capsule_small_1,
    (SpriteParts*)sprt_item_power_capsule_small_2,
    (SpriteParts*)sprt_item_power_capsule_small_3,
    (SpriteParts*)sprt_item_power_capsule_big_closed,
    (SpriteParts*)sprt_item_power_capsule_big_1,
    (SpriteParts*)sprt_item_power_capsule_big_2,
    (SpriteParts*)sprt_item_power_capsule_big_3,
    (SpriteParts*)sprt_item_energy_capsule_small_1,
    (SpriteParts*)sprt_item_energy_capsule_small_2,
    (SpriteParts*)sprt_item_energy_capsule_small_3,
    (SpriteParts*)sprt_item_energy_capsule_big_1,
    (SpriteParts*)sprt_item_energy_capsule_big_2,
    (SpriteParts*)sprt_item_energy_capsule_big_3,
    (SpriteParts*)sprt_item_life_up_1,
    (SpriteParts*)sprt_item_life_up_2,
    (SpriteParts*)sprt_item_heart_tank_1,
    (SpriteParts*)sprt_item_heart_tank_2,
    (SpriteParts*)sprt_item_heart_tank_3,
    (SpriteParts*)sprt_item_heart_tank_4,
    (SpriteParts*)sprt_death_particle_1,
    (SpriteParts*)sprt_death_particle_2,
    (SpriteParts*)sprt_death_particle_3,
    (SpriteParts*)sprt_death_particle_4,
    (SpriteParts*)sprt_death_particle_5};
