...
// MMX stuff
#define MMX_WALK_SPEED FIX(1.46875)
...
void RicSetCrouch(s32 arg0, s32 velocityX);
void RicSetWalkFromJump(s32 arg0, s32 velocityX);
...
void RicSetSubweaponParams(Entity*);
s32 func_8015FDB0(Primitive* poly, s16 posX, s16 posY);
Entity* RicCreateEntFactoryFromEntity(Entity* entity, u32 arg1, s32 arg2);
